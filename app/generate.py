...
import builtin_config as builtin_config
import global_functions as global_functions
from filters import register_filters
from rule_generator import CustomRuleGenerator
...
@click.command()
@click.option('--reload/--no-reload', default=False, multiple=False, help=
